...
# class TargetTimePeriodsRollingTargetRate(MultiCoordinatorEntity, BinarySensorEntity, RestoreEntity):
...
#     return f"target_time_periods_rolling_target_{self._config[CONFIG_TARGET_NAME]}"
    
#   @property
#   def name(self):
#     """Name of the sensor."""
#     return f"Target Time Period Rolling Target {self._config[CONFIG_TARGET_NAME]}"
...
#       _LOGGER.debug(f'Updating TargetTimePeriodsTargetRate {self._config[CONFIG_TARGET_NAME]}')
...
#           if (CONFIG_TARGET_INVERT_TARGET_VALUES in self._config):
#             invert_target_rates = self._config[CONFIG_TARGET_INVERT_TARGET_VALUES]
...
#           applicable_rates = get_rolling_applicable_time_periods(
#             current_local_date,
#             all_rates,
