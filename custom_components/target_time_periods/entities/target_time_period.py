...
class TargetTimePeriodsTargetRate(BinarySensorEntity, RestoreEntity):
  ...
  async def async_update(self):
    ...
    should_evaluate = should_evaluate_target_time_periods(current_date, self._target_time_periods, self._config[CONFIG_TARGET_TARGET_TIMES_EVALUATION_MODE] if CONFIG_TARGET_TARGET_TIMES_EVALUATION_MODE in self._config else CONFIG_TARGET_TARGET_TIMES_EVALUATION_MODE_ALL_IN_PAST)
    if should_evaluate:
