...
# class TargetTimePeriodsTargetRate(MultiCoordinatorEntity, BinarySensorEntity, RestoreEntity):
...
#     return f"target_time_periods_target_{self._config[CONFIG_TARGET_NAME]}"
    
#   @property
#   def name(self):
#     """Name of the sensor."""
#     return f"Target Time Period Target {self._config[CONFIG_TARGET_NAME]}"
