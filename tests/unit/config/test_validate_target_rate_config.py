...
from custom_components.target_time_periods.config.target_time_period import validate_target_rate_config
from custom_components.target_time_periods.const import CONFIG_TARGET_END_TIME, CONFIG_TARGET_HOURS, CONFIG_TARGET_HOURS_MODE, CONFIG_TARGET_HOURS_MODE_EXACT, CONFIG_TARGET_HOURS_MODE_MAXIMUM, CONFIG_TARGET_HOURS_MODE_MINIMUM, CONFIG_TARGET_MAX_VALUE, CONFIG_TARGET_MIN_VALUE, CONFIG_TARGET_MPAN, CONFIG_TARGET_NAME, CONFIG_TARGET_OFFSET, CONFIG_TARGET_START_TIME, CONFIG_TARGET_TYPE, CONFIG_TARGET_TYPE_CONTINUOUS, CONFIG_TARGET_TYPE_INTERMITTENT, CONFIG_TARGET_WEIGHTING
...
async def test_when_hour_mode_is_minimum_and_minimum_or_maximum_value_is_specified_then_no_error_returned(min_rate: float, max_rate: float):
  # Arrange
  data = {
    CONFIG_TARGET_TYPE: CONFIG_TARGET_TYPE_CONTINUOUS,
    CONFIG_TARGET_NAME: "test",
    ...
    CONFIG_TARGET_END_TIME: "00:00",
    CONFIG_TARGET_OFFSET: "-00:30:00",
    CONFIG_TARGET_MIN_VALUE: min_rate,
    CONFIG_TARGET_MAX_VALUE: max_rate,
